    ...
    return (
        <React.Fragment>
           <div className={`${styles.profile_buttons} w-100 px-5 d-flex justify-content-end align-items-center gap-3`}> 
                ...
                <button className="">Edit <span className="ms-2"><svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20" fill="none">
           ...
           <div className="container">
                <div className="row">
                    ...
                    <div className={`${styles.user_profile_detail} col-md-8`}>
