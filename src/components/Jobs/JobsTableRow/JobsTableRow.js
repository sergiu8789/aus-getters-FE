    ...
    <div className={styles.TableRowParent}>
      <div className={styles.RowFirstLine}>
        ...
        <div className={styles.TextContainer}>
          ...
          <div className="d-flex gap-4 flex-wrap align-content-center align-items-center">
            <div className={styles.JobDeatils}>
              <span>
                <svg
      ...
      <div className={styles.RowMiddleLine}>6 may 2023</div>
      <div className={styles.RowLastLine}>
        <span className={styles.status}>Active</span>
      </div>
      <div className={`${styles.RowLastLine} d-flex `}>
        <button className={styles.BtnCustomPrimary}>View Application</button>
        {type === 'bookmark' && (
          <button>
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            >
              <path
                d="M9 7.19961C9 5.21138 10.6118 3.59961 12.6 3.59961H23.4C25.3883 3.59961 27 5.21138 27 7.19961V32.3996L18 27.8996L9 32.3996V7.19961Z"
                fill="#6F71F1"
              />
            </svg>
          </button>
