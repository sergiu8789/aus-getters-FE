        ...
        <div className={styles.jobDescription}>
          ...
          <div>
            ...
            <ul>
              ...
              <li>
                mus porta non lectus quis consequat. Aenean sem elit, feugiat
                eget tortor ut, suscipit facilisis mauris. Curabitur id bibendum
                ipsum, vel gravida enim. Ut
              </li>
              <li>
                lla facilisi. Sed lacinia diam libero, commodo ornare ante
                tempor vel. Vestibulum condimentum bibendum viverra. Proin purus
                mi, elementum et tellus eget,
              </li>
              <li>
